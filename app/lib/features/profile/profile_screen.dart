      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(l10n.profileGuest, style: theme.textTheme.titleLarge),
            ...
            _Row(icon: Icons.notifications_outlined, label: l10n.rowNotifications, onTap: () {}),
            _Row(
            ...
            _Row(icon: Icons.lock_outline, label: l10n.rowPrivacy, onTap: () {}),
            _Row(icon: Icons.description_outlined, label: l10n.rowTerms, onTap: () {}),
            _Row(icon: Icons.logout, label: l10n.rowSignOut, onTap: () {}),
            const SizedBox(height: 12),
            Center(
              child: Text('${l10n.appName} · v1.0.0',
